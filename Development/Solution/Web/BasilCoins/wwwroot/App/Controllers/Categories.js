angular.module('app')
    .controller('Categories', ['$scope', '$state', '$rootScope', function ($s, $st, $rs) {
        $s.ShowFilter = false;
        new WOW().init();
        ...
        $s.RelatedCategories = [
            { ID: 1, name: 'Royal Canadian Mint', image: 'uq_1.jpg', count: 4 },
        ...
        $s.DetailName = $s.RelatedCategories[0].name; 0


        $s.Categories = [
            { ID: 1, name: 'USA Series & Mint Sets', image: 'sc_1.jpg' },
            { ID: 2, name: 'USA 1/2 Cent (1857 - 1973)', image: 'sc_2.jpg' },
            { ID: 3, name: 'USA 1 Cent', image: 'sc_3.jpg' },
            { ID: 4, name: 'USA 2 Cents (1864 - 1873)', image: 'sc_4.jpg' },
            { ID: 5, name: 'USA 3 Cents (1851 - 1889)', image: 'sc_5.jpg' },
            { ID: 6, name: 'USA Half Dime (1794 - 1873)', image: 'sc_6.jpg' },
            { ID: 7, name: 'USA Nickel', image: 'sc_7.jpg' },
        ]
